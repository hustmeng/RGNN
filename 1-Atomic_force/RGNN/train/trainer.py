...
class Trainer:
    ...
    def restore_checkpoint(self, epoch=None):
        ...
        self.state_dict = torch.load(chkpt)#,map_location=device)

    def train(self, device, n_epochs=sys.maxsize, lambda_=0.01, conductance = None):
        """
            ...
            for _ in range(n_epochs):
                ...
                for train_batch in train_iter:
                    ...
                    with torch.cuda.amp.autocast():
                        result = self._model(train_batch,conductance)
                ...
                if self.epoch % self.validation_interval == 0 or self._stop:
                    ...
                    for val_batch in self.validation_loader:
                        ...
                        val_result = self._model(val_batch,conductance)
                        val_batch_loss = (
                    ...
                    if self.best_loss > val_loss:
                        ...
                        torch.save(self.state_dict,"best_state_dict.pkl")
