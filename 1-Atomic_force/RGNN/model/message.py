...
class NodeUpdate(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.fc1 = Linear(
            n_node_feature + n_edge_feature, n_node_feature + n_edge_feature, activation=None
        )
        self.fc2 = Linear(
    ...
    def forward(
        ...
        #node_embedding = self.gelu(node_embedding + nbr_sumed)
...
class EdgeUpdate(nn.Module):
    ...
    def __init__(
        ...
        self.fc_two_body_1 = Linear(n_node_feature,     n_node_feature, activation=None)
        self.fc_two_body_2 = Linear(n_node_feature, 2 * n_edge_feature, activation=None)
        ...
        self.fc_three_body_1 = Linear(
            3 * n_node_feature + 2 * n_edge_feature,
            2 * n_edge_feature,
            activation=None,
        )
        self.fc_three_body_2 = Linear(
            2 * n_edge_feature,
            2 * n_edge_feature,
            activation=None,
        )
    ...
    def forward(
        ...
        c2 = self.fc_two_body_1(c2)
        c2 = self.relu(c2)
        c2 = self.fc_two_body_2(c2)
        ...
        c3 = self.fc_three_body_1(c3)
        c3 = self.relu(c3)
        c3 = self.fc_three_body_2(c3)
        ...
        # last activation layer and Residual Network
        edge_embedding = self.tanh(edge_embedding + two_body_embedding + three_body_embedding)
        #edge_embedding = self.gelu(edge_embedding + two_body_embedding + three_body_embedding)
